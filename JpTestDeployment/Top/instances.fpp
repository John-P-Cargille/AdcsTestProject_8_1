module JpTestDeployment {
  ...
  instance adcsComponent: AdcsModule.AdcsComponent base id 0x0E00 \
    queue size Default.QUEUE_SIZE \
    stack size Default.STACK_SIZE \
    priority 100
  ...
  instance linuxI2cDriver: Drv.LinuxI2cDriver base id 0x4B00

  # instance comBufferManager: Svc.BufferManager base id 0x4C00
