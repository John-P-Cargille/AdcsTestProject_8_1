module JpTestDeployment {
  ...
  topology JpTestDeployment {
    ...
    connections ADCS {
      adcsComponent.AdcsI2cRead -> linuxI2cDriver.read
      # linuxI2cDriver.allocate -> comBufferManager.bufferGetCallee # Allocation
      # linuxI2cDriver.deallocate -> comBufferManager.bufferSendIn # Deallocation when finished
    }
