// ======================================================================
// \title  JpTestDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef JPTESTDEPLOYMENT_JPTESTDEPLOYMENTTOPOLOGY_HPP
#define JPTESTDEPLOYMENT_JPTESTDEPLOYMENTTOPOLOGY_HPP
// Included for access to JpTestDeployment::TopologyState and JpTestDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <JpTestDeployment/Top/JpTestDeploymentTopologyDefs.hpp>

// Remove unnecessary JpTestDeployment:: qualifications
using namespace JpTestDeployment;
 ...
 * JpTestDeployment::TopologyState see: JpTestDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type JpTestDeployment::TopologyState see: JpTestDeploymentTopologyDefs.hpp.
 *
