// ======================================================================
// \title  JpTestDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <JpTestDeployment/Top/JpTestDeploymentTopologyAc.hpp>
...
void configureTopology() {
    ...
    //tlmSend.setPacketList(JpTestDeploymentPacketsPkts, JpTestDeploymentPacketsIgnore, 1);
}

// Public functions for use in main program are namespaced with deployment name JpTestDeployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        JpTestDeployment::blockDrv.callIsr();
