// ======================================================================
// \title  JpTestDeploymentTopologyAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for JpTestDeployment topology
// ======================================================================
...
namespace JpTestDeployment {
  ...
  AdcsModule::AdcsComponent adcsComponent(FW_OPTIONAL_NAME("adcsComponent"));
  ...
  Drv::LinuxI2cDriver linuxI2cDriver(FW_OPTIONAL_NAME("linuxI2cDriver"));
  ...
  void initComponents(const TopologyState& state) {
    adcsComponent.init(QueueSizes::adcsComponent, InstanceIds::adcsComponent);
    ...
    linuxI2cDriver.init(InstanceIds::linuxI2cDriver);
  ...
  void setBaseIds() {
    ...
    adcsComponent.setIdBase(BaseIds::adcsComponent);
    ...
    linuxI2cDriver.setIdBase(BaseIds::linuxI2cDriver);
  }

  void connectComponents() {

    // ADCS
    adcsComponent.set_AdcsI2cRead_OutputPort(
        0,
        linuxI2cDriver.get_read_InputPort(0)
    );

    // Command
    cmdDisp.set_compCmdSend_OutputPort(
        0,
        adcsComponent.get_cmdIn_InputPort(0)
    );
    cmdDisp.set_compCmdSend_OutputPort(
        1,
    ...
    // CommandRegistration
    adcsComponent.set_cmdRegOut_OutputPort(
        0,
    ...
    // CommandResponse
    adcsComponent.set_cmdResponseOut_OutputPort(
        0,
    ...
    // Events
    adcsComponent.set_logOut_OutputPort(
        0,
    ...
    // Parameters
    adcsComponent.set_prmGetOut_OutputPort(
        0,
        prmDb.get_getPrm_InputPort(0)
    );
    adcsComponent.set_prmSetOut_OutputPort(
        0,
    ...
    // Telemetry
    adcsComponent.set_tlmOut_OutputPort(
        0,
    ...
    // TextEvents
    adcsComponent.set_logTextOut_OutputPort(
        0,
    ...
    // Time
    adcsComponent.set_timeCaller_OutputPort(
        0,
  ...
  void startTasks(const TopologyState& state) {
    adcsComponent.start(
      static_cast<NATIVE_UINT_TYPE>(Priorities::adcsComponent),
      static_cast<NATIVE_UINT_TYPE>(StackSizes::adcsComponent),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<NATIVE_UINT_TYPE>(TaskIds::adcsComponent)
    );
    blockDrv.start(
  ...
  void freeThreads(const TopologyState& state) {
    (void) adcsComponent.ActiveComponentBase::join(nullptr);
