...
#include <JpTestDeployment/Top/JpTestDeploymentPacketsAc.hpp>
...
namespace JpTestDeployment {
  ...
  static const Svc::TlmPacketizerChannelEntry ADCSList[] = {
      {3584, 1}, // adcsComponent.RECENT_READ
  };

  static const Svc::TlmPacketizerPacket ADCS = { ADCSList, 10, 3, FW_NUM_ARRAY_ELEMENTS(ADCSList) };



  const Svc::TlmPacketizerPacketList JpTestDeploymentPacketsPkts = {
      {
         &CDH,
         &CDHErrors,
         &DriveTlm,
  ...
  const Svc::TlmPacketizerPacket JpTestDeploymentPacketsIgnore = { ignoreList, 0, 0, FW_NUM_ARRAY_ELEMENTS(ignoreList) };

} // end namespace JpTestDeployment
