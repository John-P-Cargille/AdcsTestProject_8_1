...
#include <JpTestDeployment/Top/JpTestDeploymentTopology.hpp>
...
static void signalHandler(int signum) {
    JpTestDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    JpTestDeployment::TopologyState inputs;
    ...
    JpTestDeployment::setupTopology(inputs);
    JpTestDeployment::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    JpTestDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
